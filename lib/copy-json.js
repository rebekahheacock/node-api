...
// cat reads data/example.json and loads it into stdout
// pipe takes stdout and loads it into stdin
// setting inFile to stdin then reads from stdin instead of reading directly from data/example.js
...
fs.readFile(inFile, { encoding: 'utf8' }, (error, data) => {
  ...
  pojo.user.email = 'thebestemailever@email.com';
